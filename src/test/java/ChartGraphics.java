...
public class ChartGraphics {
    ...
    public void graphicsGeneration(String name, String id, String classname, String imgurl) {
        ...
        btn2.drawString("单击你妹啊", 120, btn2_2_top+(H_btn/2)+50);


        createImage("/Users/zhaohongtao/IdeaProjects/convertio/tmp/targetDir/hehe.jpg");
    ...
    public static void main(String[] args) {
        ...
        try {
            cg.graphicsGeneration("ewew", "1", "12", "/Users/zhaohongtao/IdeaProjects/convertio/tmp/targetDir/1.jpg");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
